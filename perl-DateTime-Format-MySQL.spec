...
Requires: perl-DateTime-Format-MySQL-license
...
Group: Development
Provides: perl-DateTime-Format-MySQL-devel
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/perl-DateTime-Format-MySQL
cp LICENSE %{buildroot}/usr/share/doc/perl-DateTime-Format-MySQL/LICENSE
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/DateTime/Format/MySQL.pm
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/perl-DateTime-Format-MySQL/LICENSE
