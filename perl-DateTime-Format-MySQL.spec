...
%prep
%setup -q -n DateTime-Format-MySQL-0.0701
cd %{_builddir}/DateTime-Format-MySQL-0.0701
...
cp %{_builddir}/DateTime-Format-MySQL-0.0701/LICENSE %{buildroot}/usr/share/package-licenses/perl-DateTime-Format-MySQL/f235ba4160673bcb7c9d58c2f09dbc7fc0efadea
if test -f Makefile.PL; then
